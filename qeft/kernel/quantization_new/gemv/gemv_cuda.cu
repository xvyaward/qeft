...
__global__ void gemv_kernel_perchannel(
  const half* inputs, const uint32_t* weight, const half* scales, const half* zeros, half* outputs, 
  const int IC, const int OC)
{
    const int kStride = 64;
    ...
    int group_size)
{
    ...
    //   {
    //   case 1:
    //     gemv_kernel_perchannel<N_PER_BLOCK, 1, BLOCK_SIZE><<<num_blocks, num_threads>>>(
    //       in_feats, kernel, scaling_factors, zeros, out_feats, k, n
    //     );
    //     break;
    //   case 2:
    //     gemv_kernel_perchannel<N_PER_BLOCK, 2, BLOCK_SIZE><<<num_blocks, num_threads>>>(
    //       in_feats, kernel, scaling_factors, zeros, out_feats, k, n
    //     );
    //     break;
    //   case 3:
    //     gemv_kernel_perchannel<N_PER_BLOCK, 3, BLOCK_SIZE><<<num_blocks, num_threads>>>(
    //       in_feats, kernel, scaling_factors, zeros, out_feats, k, n
    //     );
    //     break;
    //   case 4:
    //     gemv_kernel_perchannel<N_PER_BLOCK, 4, BLOCK_SIZE><<<num_blocks, num_threads>>>(
    //       in_feats, kernel, scaling_factors, zeros, out_feats, k, n
    //     );
    //     break;
    //   case 5:
    //     gemv_kernel_perchannel<N_PER_BLOCK, 5, BLOCK_SIZE><<<num_blocks, num_threads>>>(
    //       in_feats, kernel, scaling_factors, zeros, out_feats, k, n
    //     );
    //     break;
    //   case 6:
    //     gemv_kernel_perchannel<N_PER_BLOCK, 6, BLOCK_SIZE><<<num_blocks, num_threads>>>(
    //       in_feats, kernel, scaling_factors, zeros, out_feats, k, n
    //     );
    //     break;
    //   case 7:
    //     gemv_kernel_perchannel<N_PER_BLOCK, 7, BLOCK_SIZE><<<num_blocks, num_threads>>>(
    //       in_feats, kernel, scaling_factors, zeros, out_feats, k, n
    //     );
    //     break;
    //   default:
